...
const dictionaries = {
  en: {
    ...
    uploadScriptIntro: "Upload a answered paper for analysis. Check the file if upload fails.",
    ...
    examUploadHint: "PDF or image. If upload fails, please check the file.",
  ...
  "zh-HK": {
    ...
    uploadScriptIntro: "上載已作答試卷以進行分析。若失敗請檢查檔案。",
    resultsTitle: "分析結果",
    ...
    examUploadKey: "上載答案",
    examUploadHint: "PDF 或圖片。若上載失敗，請檢查檔案。",
    examAnalyze: "開始結構分析",
    examAnalyzing: "啟動中…",
